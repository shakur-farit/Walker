...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Effects.EffectSetups effectSetups { get { return (Code.Gameplay.Features.Effects.EffectSetups)GetComponent(GameComponentsLookup.EffectSetups); } }
    ...
    public GameEntity AddEffectSetups(System.Collections.Generic.List<Code.Gameplay.Features.Effects.EffectSetup> newValue) {
        ...
        var component = (Code.Gameplay.Features.Effects.EffectSetups)CreateComponent(index, typeof(Code.Gameplay.Features.Effects.EffectSetups));
